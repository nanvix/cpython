...
### Clean-Pass Modules (External Libs)

These modules pass with zero manual skips needed:

- test_zlib, test_gzip, test_bz2 (compression)
- test_hashlib, test_hmac (hashing)
- test_sqlite3 (database)

### Excluded Modules (External Libs)

| Module | Reason |
|--------|--------|
| test_lzma | liblzma not present in Nanvix sysroot |
