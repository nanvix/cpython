...
NANVIX_TEST_LIST ?= \
    ...
    test_list test_dict \
    test_string test_string_literals test_unicode test_unicodedata test_ucn \
    test_format test_fstring \
    test_codecs test_codeccallbacks \
    ...
    test_pickle test_pickletools test_marshal \
    test_json test_csv \
    test_base64 test_binascii test_quopri test_uu \
    test_textwrap test_difflib test_fnmatch test_glob test_shlex test_re
