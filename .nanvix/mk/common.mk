...
# Filesystem/IO modules added per issue #324. See NANVIX_SKIP_LIST.md for skip details.
NANVIX_TEST_LIST ?= \
    ...
    test_os test_stat test_posixpath test_pathlib test_genericpath \
    test_tempfile \
    test_shutil test_glob test_fnmatch \
    test_zipfile test_tarfile test_zipimport \
    test_configparser test_csv \
    test_mmap \
    test_shelve test_dbm test_dbm_dumb test_dbm_ndbm test_dbm_gnu \
    test_linecache test_source_encoding test_largefile \
    test_import test_importlib test_modulefinder test_pkgutil test_zipapp
