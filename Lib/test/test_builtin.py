...
class BuiltinTest(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: pickle corruption on 32-bit")  # gh-371
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: round-half-up instead of round-half-to-even")  # gh-371
    def test_round(self):
    ...
    @unittest.skipIf((linux_alpha and system_round_bug) or support.is_nanvix,  # gh-371
