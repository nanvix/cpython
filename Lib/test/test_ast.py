...
class AST_Tests(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: pickle is broken on 32-bit")  # gh-371
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: deep recursion test may crash 32-bit VM")  # gh-371
    @support.cpython_only
...
class ModuleStateTests(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: _testcapi not available")  # gh-371
