...
class ContextManagerTestCase(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: traceback.FrameSummary.line returns '1 / 0' instead of '1/0'")  # gh-371
...
class FileContextTestCase(unittest.TestCase):
    ...
    @unittest.skipIf(support.is_nanvix, "Nanvix: tempfile.mktemp() fails due to garbled temp dir name")  # gh-371
